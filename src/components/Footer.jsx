...
function Footer() {
  return (
    <div>
        <div className='flex gap-5 w-full h-screen bg-zinc-900 p-10 font-["Founders_Grotesk"]'>
            <div className='w-1/2 h-full flex flex-col justify-between '>
                <div className='heading'>
                    <h1 className='uppercase text-[8vw]  leading-[9vw] tracking-tighter -mb-10 font-semibold'>Eye-</h1>
                    <h1 className='uppercase text-[8vw]  leading-[9vw] tracking-tighter -mb-10 font-semibold'>Opening</h1>
            ...
            <div className='w-1/2'>
                <h1 className='uppercase text-[7vw]  leading-[9vw] tracking-tighter -mb-10 font-semibold'>
                    presentations
